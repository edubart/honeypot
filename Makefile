...
CONFIG_STATE_BLOCK_DEVICE       := "/dev/pmem1"
...
honeypot: honeypot.cpp dep/linux-headers
...
lint: honeypot.cpp dep/linux-headers
...
dep/linux-headers:
	tar -C dep/ -xf dep/linux-headers.tar.xz
	mv dep/opt/riscv/kernel/work/linux-headers dep/linux-headers
	rm -rf dep/opt
